  ...
  categories: [
    {
      ...
      featured: [
        ...
        {
          name: 'Karnage Collection Poppers',
          href: '#',
          imageSrc: '/StickBaits.jpg',
          imageAlt: 'Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.',
        },
        {
          name: 'Clothing',
          href: '#',
          imageSrc: '/teaShirt.png',
                          ...
                          {category.featured.map((item, itemIdx) => (
                            ...
                            >
                              ...
                              <div className="flex flex-col justify-end">
                                <div className="bg-white bg-opacity-80 p-4 text-base sm:text-sm">
                                  <a href={item.href} className="font-medium text-xl text-gray-900">
                                    <span className="absolute inset-0" aria-hidden="true" />
                                    {item.name}
                                  </a>
                                  <p aria-hidden="true" className="mt-0.5 text-sky-700 text-bold text-xl sm:mt-1">
                                    Shop now
                                  </p>
                                </div>
                              </div>
                            ...
                            {column.map((section) => (
                              <div key={section.name}>
                                <p
                                  ...
                                  className="font-medium text-gray-900 text-2xl"
                                >
                                  {section.name}
                                </p>
                                <ul
                                ...
                                >
                                  {section.items.map((item) => (
                                    <li key={item.name} className="flow-root">
                                      <a href={item.href} className="-m-2 block p-2 text-gray-500 text-xl">
                                        {item.name}
                                      </a>
                                    </li>
                                  ))}
                ...
                <div className="space-y-6 border-t border-gray-200 py-6 px-4">
                  {navigation.pages.map((page) => (
                    <div key={page.name} className="flow-root">
                      <a href={page.href} className="-m-2 block p-2 font-medium text-2xl text-gray-900">
                        {page.name}
                      </a>
                    </div>
                  ))}
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center justify-between">
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                'relative z-10 flex items-center justify-center text-lg font-medium transition-colors duration-200 ease-out'
                              )}
                            >
                              {category.name}
                              <span
                              ...
                              <div className="relative bg-white">
                                <div className="mx-auto max-w-7xl px-8">
                                  <div className="grid grid-cols-2 gap-y-10 gap-x-8 py-16">
                                        ...
                                        >
                                          ...
                                          <div className="flex flex-col justify-end ">
                                            <div className="bg-white bg-opacity-80 p-4 text-md">
                                              ...
                                              <p aria-hidden="true" className="mt-0.5 text-green-700 text-xl text-bold sm:mt-1">
                                                Shop now
                                              </p>
                                            </div>
                                          </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-y-10 gap-x-8 text-lg text-gray-500">
                                      {category.sections.map((column, columnIdx) => (
                                        <div key={columnIdx} className="space-y-10">
                                          {column.map((section) => (
                                            <div key={section.name}>
              ...
              <Link href="/" className="flex">
                ...
                <Image className="h-10 w-auto" src="/KoasLogoBlack.svg" alt=""  width={100} height={50} />
              </Link>
