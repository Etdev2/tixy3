...
import KoasLogoBlack from '../public/KoasLogoBlack.svg'
import LogoClean from '../public/LogoClean.svg'
const navigation = {
  categories: [
    {
      id: 'women',
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                open ? 'text-indigo-600' : 'text-primary-700 hover:text-gray-800',
